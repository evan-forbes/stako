...
//! `config.toml`. The `capabilities` array is the only field that
//! matters for the policy evaluator.
//!
//! The local mutation token (`state/local_token`) always resolves to
