...
pub fn build(b: *std.Build) void {
    ...
    const item_format_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("test/item_format_tests.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "organo", .module = mod },
    ...
    const run_item_format_tests = b.addRunArtifact(item_format_tests);
    ...
    const adapter_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("test/adapter_tests.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "organo", .module = mod },
